...
function EmptyState() {
  return (
    ...
    >
      <h2 className="text-3xl font-semibold text-slate-900 dark:text-white">No analysis yet</h2>
      <p className="mt-3 text-slate-500 dark:text-slate-400">Run an analysis from the analyzer workspace to populate your dashboard.</p>
