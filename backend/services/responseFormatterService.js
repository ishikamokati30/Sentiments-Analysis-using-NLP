const { tokenize, normalizeText, POSITIVE_WORDS, NEGATIVE_WORDS } = require("./textUtils");
 ...
 */
function formatStrictResponse(text, advancedAnalysis, sentimentResult, emotionResult, sarcasmResult, language = "english") {
  const keywords = extractSentimentKeywords(text, sentimentResult, sarcasmResult);
